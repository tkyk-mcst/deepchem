...
class _OptimizeScreenState extends State<OptimizeScreen>
  ...
  Map<String, dynamic> _buildObjectives() {
    ...
    for (final obj in _objectives) {
      ...
      if (obj.mode == 'target' && obj.target != null) {
        cfg['target'] = obj.target;
      }
      m[obj.property] = cfg;
    }
    return m;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      label: Text(
                        context.l10n.optimizeShowSeedProps,
                    ...
                    ..._objectives.asMap().entries.map(
                      (e) => _ObjRowWidget(
                        key: ValueKey(e.key),
                        row: e.value,
                        availableProps: _availableProps,
                        onDelete: () =>
                            setState(() => _objectives.removeAt(e.key)),
                        onChanged: () => setState(() {}),
                      ),
                    ),
...
class _StatusBadge extends StatelessWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (job.isDone)
                  Text(
                    context.l10n.optimizeFoundCandidates(
                      job.result?['n_results'] as int? ?? 0,
                    ),
  ...
  String _label(BuildContext context, String s) {
    switch (s) {
      case 'pending':
        return context.l10n.optimizePending;
      case 'running':
        return context.l10n.optimizeRunning;
      case 'done':
        return context.l10n.optimizeDone;
      case 'error':
        return context.l10n.optimizeError;
      default:
        return s;
    }
  }
  ...
  Widget build(BuildContext context) => Center(
    child: Column(
      ...
      children: [
        ...
        Text(
          context.l10n.optimizeSetParams,
          style: const TextStyle(color: Colors.white60, fontSize: 16),
        ),
        const SizedBox(height: 6),
        Text(
          context.l10n.optimizeSelfiesDesc,
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              context.l10n.optimizeEvolving,
              style: const TextStyle(color: Colors.white70, fontSize: 16),
            ),
            const SizedBox(height: 6),
            Text(
              context.l10n.optimizeJobLabel(job.id),
              style: const TextStyle(
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 12),
              Text(
                context.l10n.optimizeCandidates(results.length),
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        color: Colors.white54,
                        onPressed: () =>
                            Clipboard.setData(ClipboardData(text: selfies)),
...
class _ObjRow {
  ...
  double weight;
  double? target;
  _ObjRow({required this.property, required this.mode, required this.weight});
}
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      context.l10n.commonWeightLabel(
                        widget.row.weight.toStringAsFixed(1),
                      ),
                      style: const TextStyle(
                        color: Colors.white54,
                        fontSize: 12,
